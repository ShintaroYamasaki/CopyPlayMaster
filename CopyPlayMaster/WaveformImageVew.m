...
-(id)initWithUrl:(NSURL*)url {
    if(self = [super init]){
        ...
        [self setImage:[UIImage imageWithData:[self renderPNGAudioPictogramLogForAsset:urlA]]];
    }
    return self;
}
...
-(UIImage *) audioImageLogGraph:(Float32 *) samples
    ...
    CGColorRef leftcolor = [[UIColor lightGrayColor] CGColor];
    CGColorRef rightcolor = [[UIColor lightGrayColor] CGColor];
